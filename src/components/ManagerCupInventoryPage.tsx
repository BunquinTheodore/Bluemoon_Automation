...
interface ManagerCupInventoryPageProps {
  user: User;
  onBack: () => void;
  onLogout: () => void;
}

export function ManagerCupInventoryPage({ user, onBack, onLogout }: ManagerCupInventoryPageProps) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl text-cyan-900">Cup Inventory Monitoring</h1>
                  <p className="text-sm text-gray-500">Manager read-only cup inventory records</p>
                </div>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        <Card className="border-cyan-100">
          <CardHeader>
            ...
            <CardDescription>Use filters to monitor branch/date discrepancies.</CardDescription>
          </CardHeader>
        ...
        <Card className="border-cyan-100">
          <CardHeader>
            ...
            <CardDescription>Read-only daily cup inventory audit trail.</CardDescription>
          </CardHeader>
          <CardContent>
